                        ...
                        <div className="ms-auto md:me-6 lg:me-12 xl:me-32">
                            <div className=" w-full  hidden md:block  transform  ">
                                <ul className="flex justify-center items-center lg:space-x-14 xl:space-x-20 space-x-8 ">
                                    ...
                                    <Link to='/user/blog' className="rounded-lg border border-blue-950 shadow-md hover:underline  transition duration-500 ease-in-out sm:text-xl md:text-sm font-semibold   tracking-wider focus:bg-sky-500 focus:text-white hover:bg-sky-500  hover:text-white  px-2 py-1 lg:px-3 lg:py-2   ">
                                        BLOG
                                    </Link>
                                    <Link to='/user/resources' className="rounded-lg border border-blue-950 shadow-md hover:underline  transition duration-500 ease-in-out sm:text-xl md:text-sm font-semibold tracking-wider focus:bg-sky-500 focus:text-white hover:bg-sky-500  hover:text-white  px-2 py-1 lg:px-3 lg:py-2 ">
                                        RESOURCES
                                    </Link>
