                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="z-50 flex flex-col justify-center items-center  w-full h-3/4  ">
                                <h1 className="my-element animate__animated animate__flipInX animate__slower text-[3.2rem] mx-auto md:text-[4.8rem] lg:text-[5.8rem] xl:text-[7rem] text-white font-bold sm:tracking-[1rem] tracking-[4.3px]" style={{
                                    fontFamily: "Oswald",
                            ...
                            <div className="sticky bottom-12 sm:bottom-44 md:bottom-52 lg:bottom-72 xl:bottom-96 h-2  z-10  left-0 w-full"
                            >
                                ...
                                <div className="flex flex-col lg:flex-row justify-center items-center w-4/5 pb-16 sm:pb-28" >
                                    <div
                                        ...
                                        <img
                                            ...
                                            alt=""
                                            className="w-full lg:w-4/5 py-8 mx-auto "
                                        />
                                    </div>
                                    <div
                                        data-aos="fade-left"
                        ...
                        <div className=" w-full h-full py-32 relative md:py-52 ">
                            ...
                            <div className="relative mx-auto mt-20 flex flex-col justify-center items-center z-40">
                                ...
                                <div
                                    ...
                                    data-aos-delay="300"
                                    data-aos-duration="1000"
                                    className="absolute yellow text-center flex flex-col justify-center items-center w-40 h-40 sm:w-48 sm:h-48  md:w-72 md:h-72 lg:w-80 lg:h-80  xl:w-96 xl:h-96 left-0 -top-8 sm:top-0 sm:left-0 md:left-2 md:-top-20 lg:left-4 lg:-top-10 xl:left-28  2xl:left-56 2xl:top-4   ">
                                ...
                                <div
                                    ...
                                    data-aos-delay="100"
                                    data-aos-duration="1000"
                                    className=" absolute  blue text-center flex flex-col justify-center items-center w-40 h-40 sm:w-48 sm:h-48 md:w-72 md:h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96 right-0 -top-28 sm:right-0 sm:-top-32 md:right-0 md:-top-52 lg:right-4 lg:-top-48 xl:right-32  2xl:right-56 2xl:-top-48">
                                    <div className="relative w-full h-full  ">
                                ...
                                <div
                                    ...
                                    data-aos-delay="500"
                                    data-aos-duration="1000"
                                    className="absolute orange text-center flex flex-col justify-center items-center w-40 h-40 sm:w-48 sm:h-48 md:w-72 md:h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96 -bottom-28 left-0  md:-bottom-48 md:left-2  lg:-bottom-48 lg:left-8 xl:left-32 xl:-bottom-56 2xl:left-72 2xl:-bottom-64 ">
                                    <div className="relative w-full h-full  ">
                                        <div className="absolute flex justify-center items-center inset-0 -z-10 ">
                                            <img
                                                className="h-full w-full object-cover"
                                ...
                                <div
                                    ...
                                    data-aos-delay="300"
                                    data-aos-duration="1000"
                                    className="absolute skin text-center flex flex-col justify-center items-center w-40 h-40 sm:w-48 sm:h-48 md:w-72 md:h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96 right-0 -bottom-9 sm:bottom-6 sm:right-0 md:-bottom-16 md:right-0 lg:-bottom-20 lg:right-16 xl:right-32 xl:-bottom-24 2xl:right-72 2xl:-bottom-16  ">
                                    <div className="relative w-full h-full  ">
                                        <div className="absolute flex justify-center items-center inset-0 -z-10 ">
                                            <img
                                                className="h-full w-full object-cover"
                        ...
                        <div className="w-full h-auto">
                            <div className="flex flex-col text-center justify-center py-24 sm:py-36 md:py-44 items-center space-y-4 h-full ">
                                ...
                                <div className="p-6 select-none">
                                    ...
                                    <div className=" w-72 sm:w-full md:w-5/6 lg:w-full xl:w-4/5 2xl:w-3/4 mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-4 xl:gap-10  text-center">

                                        <div
                                            data-aos="fade-up"
                                            data-aos-delay="200"
                                            data-aos-duration="1000"
                                            className="mx-auto  md:mx-0 md:w-full  hover:scale-105 transition-all ease-in-out hover:shadow-xl  sm:border-2 rounded-xl">
                                        ...
                                        <div
                                            ...
                                            data-aos-delay="800"
                                            data-aos-duration="1000"
                                            className="col-span-1 sm:col-span-2 lg:col-span-1 lg:w-full sm:w-1/2 mx-auto   hover:scale-105 transition-all ease-in-out hover:shadow-xl  sm:border-2 rounded-xl">
                                            <div className="flex justify-center">
                                                <div className="w-1/2 h-full">
                                                    <img
                                                        className="w-40 h-40  mx-auto"
