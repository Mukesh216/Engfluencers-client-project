...
const Resources = () => {
    ...
    const handleRscWorksheets = async () => {
        try {
            const response = await axios.get("http://192.168.0.102:3000/user/resources/worksheets");
    ...
    const handleDownload = async (fileUrl, pdfName) => {
        ...
        try {
            const response = await axios.post(
                `http://localhost:3000/user/resources/download`,
                {
                                                            ...
                                                            <div className="w-full h-full ">
                                                                <ul className="py-2">
                                                                    ...
                                                                    {ResourceCollections.map((rscCol, id) => (
                                                                        <div key={rscCol._id}
                                                                            className="hover:cursor-pointer flex border-0 border-b-2 border-gray-300 w-full my-2 hover:shadow-lg group text-blue-800 hover:bg-white align-middle "
                                                                        >
